# investiment_desafio_um
Projeto de desafio: Ferramenta de Controle de Investimentos com Excel.

  Com base nas orientações fornecidas em aula, desenvolvemos a planilha de Simulação de Investimento com o propósito de ser visualmente fácil de interpretar as informações almejadas. Previamente, também foi desenvolvida a identidade visual da empresa InvestMente, juntamente com a sua logo.

  Em relação às tabelas criadas, utilizamos as informações básicas apresentadas pelo professor, mas, claro, deixando-as todas com as minhas características, nas cores, disposição das informações e aquele jeitinho de deixar algo mais íntimo para o cliente, tendo o campo nome para deixar cada análise única.
